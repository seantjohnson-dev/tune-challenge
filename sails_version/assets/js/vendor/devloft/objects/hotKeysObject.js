(function ($, win, doc) {
  ...
  eventsNamespace = {},
  keyMatches = function(e, key) {
      return String.fromCharCode(e.which).toLowerCase() == key || special_keys[e.which] == key;
  },
  modifierMatches = function(e, modifiers) {
  ...
  matches = function(e, key, modifiers) {
      return keyMatches(e, key) && modifierMatches(e, modifiers);
  },
  buildHandler = function(key, modifiers, callback) {
      return function(e) {
  ...
  bind = function(events, context, namespace) {
  ...
  unbind = function (events, context, namespace) {
  ...
  $(doc).on('keyup', onKeyup);
	...
	DevLoft.Objects.HotKeysObject = DevLoft.Objects.BaseObject.extend({
		bind: bind,
		unbind: unbind
	});

	DevLoft.HotKeys = new DevLoft.Objects.HotKeysObject();
